...
def run_homelette_job(self, *args):
    ...
    try:
        ...
        job_spec = {
            "image": "loudprepaire/homelette-job:latest",
            "memory": "48g",
            "entrypoint": None,
            "command": [],
            "volumes": {
        ...
        pdb_objectname = "homelette_genearted/" + job_id + "/" + s3.generate_valid_object_name("homelette_output.pdb")
